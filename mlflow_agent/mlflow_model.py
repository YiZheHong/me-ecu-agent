...
This module provides the MLflow wrapper for the ECU Agent.
All utility functions have been moved to mlflow_utils.py.
...
class ECUAgentWrapper(mlflow.pyfunc.PythonModel):
    ...
    def predict(self, context, model_input):
        ...
        Args:
            ...
            model_input: Query input as dict or list of dicts
        ...
        if isinstance(model_input, dict):
            ...
            raise ValueError(f"Input must be dict or list of dicts, got: {type(model_input)}")
